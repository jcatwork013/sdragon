...
const DICT = {
  vi: {
    ...
    htPairT: 'Ghép Đôi — lật thẻ tìm cặp',
    htPair1: 'Cả bàn úp sấp. Chạm để lật một thẻ, rồi lật thẻ thứ hai.',
    htPair2: 'Hai thẻ GIỐNG NHAU thì cặp đó biến mất và ăn điểm. Khác nhau thì úp lại như cũ.',
    htPair3: 'Lật trúng liên tiếp thì nhân điểm tăng dần — nhớ mặt thẻ có lợi thật, không phải may rủi.',
    ...
    fed: 'No', hungry: 'Đói', hungryBlock: 'Dế đói lả rồi — cho nó ăn cái đã!',
    hungryHint: 'Dế đói thì không đi màn được. Bấm CHO ĂN.',
  ...
  en: {
    ...
    htPairT: 'Pair Up — flip and match',
    htPair1: 'Every card starts face down. Tap one, then tap a second.',
    htPair2: 'A MATCHING pair vanishes and scores. A mismatch flips back.',
    htPair3: 'Consecutive matches raise the multiplier — remembering cards genuinely pays.',
    ...
    fed: 'Fed', hungry: 'Hungry', hungryBlock: 'The cricket is starving — feed it first!',
    hungryHint: 'A hungry cricket cannot travel. Tap FEED.',
