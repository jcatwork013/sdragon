// ── Đa ngôn ngữ VI / EN ──────────────────────────────────────────────────────
// Mọi chuỗi hiển thị đi qua t(). Dữ liệu (tên dế, tên chương) dùng tx().
...
const DICT = {
  vi: {
    ...
    htSpecL: 'Xếp hình L hoặc T → Thập Càng: nổ cả hàng lẫn cột.',
    ...
    htPouch: 'Vàng kiếm được trong màn, dùng để huấn luyện dế.',
    htMovesD: 'Số lượt còn lại. Hết lượt mà đủ điểm là qua màn.',
    htSkillT: '5 · Kỹ năng',
    htSkFire: 'Tiếng gáy — nạp đầy bằng combo, xoá sạch một hàng ngang.',
    ...
    eggHint: 'Mỗi loài mang một thiên phú riêng — chọn xong không đổi được.',
    trait: 'Thiên phú', hatch: 'Ấp trứng',
    might: 'Sức mạnh', spirit: 'Ý chí', fortune: 'May mắn', breath: 'Tiếng gáy',
    ...
    regionRumour: 'Nghe đồn…', regionNext: 'MẢNH KẾ TIẾP',
    youAreHere: 'BẠN ĐANG Ở ĐÂY', regionJournal: 'NHẬT KÝ VÙNG', regionPreview: 'CHUYỆN SẮP TỚI',
    pokeHint: 'Chạm vào dế xem nó nói gì', episode: 'Chương', level: 'Màn',
    locked: 'Chưa mở', play: 'Chơi', nest: 'Tổ dế',
    comingSoon: 'Hết màn rồi — mảnh kế mở ở bản sau', mapProgress: 'Màn {n}/{m}', journeyReady: 'Sẵn sàng lên đường',
    ...
    duelClashWin: 'ĐỌ CÀNG — bạn đè được!', duelClashLose: 'ĐỌ CÀNG — nó đè được!',
    duelCrit: 'CHÍ MẠNG!', duelCharged: 'GỒNG!',
    duelRage: 'NỘ — ăn đòn là nạp', duelRageReady: 'NỘ ĐẦY — hiệp sau nổi điên!',
    duelRageOn: 'ĐANG NỘ — đòn nặng gấp đôi', duelBeats: 'thắng', duelRing: 'Vòng khắc chế',
    duelStreak: 'CHUỖI THẮNG ×{n}',
    ...
    duelTipLose: 'Về Tổ Dế luyện thêm rồi quay lại — đối thủ luôn được ghép cân sức với bạn.',
    ...
    foesShort: 'Còn {n} thiên địch · diệt hết để lấy 3 sao',
    starNext: 'Còn {d} điểm nữa là {n} sao', starMax: 'Đã chắc 3 sao!',
    foesEscaped: 'Bỏ sót {n} thiên địch → chỉ 1 sao, mất 25% vàng',
    penalty: 'Phạt: −{g} vàng · −{x} EXP',
    wasted: '−1 lượt!', bonk: 'BỐP!',
    ...
    foodShots: 'Ăn +{n} lượt · còn {food}', foodShotsShort: 'Ăn +{n} · {food}',
    shotsAdded: '+{n} lượt bắn!', foodEmpty: 'Hết thức ăn!',
    ...
    htShootD: 'Kéo để ngắm rồi thả để bắn — tối đa 3 viên có thể bay cùng lúc. Ba viên cùng màu chạm nhau là vỡ. Nổ liên tiếp sẽ nhân điểm ×2 → ×3 → ×5 → ×8 → ×13 → ×21; bắn không nổ sẽ đứt chuỗi. Có thể dùng 1 thức ăn để nhận thêm 5 lượt bắn. Chạm viên kế bên để đổi.',
    ...
    // kết quả
    pairMode: 'Nối Cặp', pairFlips: 'Lượt thử', pairTries: 'Lượt thử', pairLeft: 'Còn {n} cặp',
    pairStreak: 'Nối đẹp ×{n}!', pairBest: 'Chuỗi dài nhất: {n}', pairCleared: 'Sạch bàn!',
    pairHint: 'GỢI Ý  ×{n}', pairNoHints: 'Hết lượt gợi ý rồi!',
    pairBlocked: 'Cùng hình, nhưng đường đang bị chặn!', pairNotSame: 'Chọn hai hình giống nhau nha!',
    pairShuffled: 'Bí đường — đã xáo bàn mới!', pairOutOfTries: 'Hết lượt thử',
    bravoFlips: 'Lượt thử thừa → vàng',
    htPairT: 'Nối Cặp — tìm đường sáng',
    htPair1: 'Chạm hai ô CÙNG HÌNH để nối. Ô hợp lệ sẽ biến mất và mở thêm đường mới.',
    htPair2: 'Đường nối đi qua ô trống, được vòng ngoài bàn và chỉ rẽ tối đa HAI GÓC.',
    htPair3: 'Nối liên tiếp để nhân điểm. Bí quá hãy dùng GỢI Ý; nếu hết nước, bàn sẽ tự xáo.',
    htSquare: 'Bốn viên xếp thành HÌNH VUÔNG 2×2 cũng nổ — không chỉ hàng ngang hay cột dọc.',
    htRage: 'Thanh NỘ — nạp khi ăn điểm VÀ khi ăn đòn. Đầy là bùng: nổ một dải, giáng đòn lên mọi thiên địch, điểm ×2.',
    fed: 'Sức', hungry: 'Kiệt sức', hungryBlock: 'Dế hết sức rồi — cho nó ăn cái đã!',
    hungryHint: 'Hết sức thì không đi màn được — cho ăn hoặc ngồi nghỉ.',
    restWait: 'Hết sức rồi. Nghỉ {t} nữa, hoặc cho ăn.',
    restIn: 'Đủ sức đi màn sau {t}', restFull: 'Hồi đầy sau {t}', orFeed: 'hoặc cho ăn',
    restTitle: 'Dế đang mệt!', restBody: 'Nó lết không nổi nữa — cho ăn, hoặc để nó nghỉ một lát.',
    costFed: '−{n} sức',
    chapterGo: 'Lên đường!', regionGo: 'Tới vùng đất mới!',
    regionDone: 'ĐÃ CHINH PHỤC', regionOpening: 'Đang mở đường sang mảnh kế…',
    regionNew: 'VÙNG ĐẤT MỚI', regionSoon: 'Còn đang khai phá',
    regionSoonNote: 'Nội dung vùng này sẽ mở trong bản tới.',
    rage: 'NỘ', furyGo: 'NỔI NỘ!', furyOn: 'ĐANG NỘ · điểm ×2',
    furyOnShort: 'ĐANG NỘ  ·  ĐIỂM ×2', furyBoost: 'TOÀN MÀN BÙNG CHÁY  ·  ĐIỂM ×2', furyBadge: 'NỘ ×2',
    bag: 'Tủ đồ', sell: 'Bán', askBuy: 'Mua món này?', askSell: 'Bán món này?',
    askAfter: 'Còn lại: {g} vàng', askYesBuy: 'Mua', askYesSell: 'Bán', cancel: 'Huỷ',
    shopSold: 'Đã bán {n} · +{g} vàng', bagEmpty: 'Tủ chưa có món nào ở ô này.',
    shop: 'Cửa hàng', shopPoor: 'Không đủ vàng!', shopBought: 'Đã mua {n}!',
    shopEmpty: 'Chưa có món nào ở ô này.', wear: 'Mặc vào',
    needStage: 'Cần {s} mới mặc được', reqStage: 'Cần {s}',
    ...
    outOfMoves: 'Hết lượt đi', vitalityGone: 'Dế kiệt sức',
    newStage: 'Dế của bạn lột xác!',

    // lời khen combo
    praise: ['Tốt!', 'Hay lắm!', 'Tuyệt vời!', 'Xuất sắc!', 'Bùng nổ!', 'GÁY VANG TRỜI!'],
  },
  en: {
    ...
    htPouch: 'Gold earned this level, spent on training your cricket.',
    htMovesD: 'Moves left. Run out with enough score and you clear the level.',
    htSkillT: '5 · Skills',
    htSkFire: 'War chirp — charges on combos, wipes one row.',
    ...
    might: 'Might', spirit: 'Spirit', fortune: 'Fortune', breath: 'Chirp',
    ...
    regionRumour: 'Word has it…', regionNext: 'UP NEXT',
    youAreHere: 'YOU ARE HERE', regionJournal: 'REGION JOURNAL', regionPreview: 'COMING STORY',
    pokeHint: 'Tap the cricket and see what it says', episode: 'Episode', level: 'Level',
    locked: 'Locked', play: 'Play', nest: 'Nest',
    comingSoon: 'End of content — next region in a later release', mapProgress: 'Level {n}/{m}', journeyReady: 'Ready for the road',
    ...
    duelClashWin: 'CLASH — you overpower it!', duelClashLose: 'CLASH — it overpowers you!',
    duelCrit: 'CRITICAL!', duelCharged: 'CHARGED!',
    duelRage: 'RAGE — fills when you are hit', duelRageReady: 'RAGE FULL — berserk next round!',
    duelRageOn: 'BERSERK — double damage', duelBeats: 'beats', duelRing: 'What beats what',
    duelStreak: 'WIN STREAK ×{n}',
    ...
    foesShort: '{n} predators left · clear all for 3 stars',
    starNext: '{d} more points for {n} stars', starMax: '3 stars secured!',
    foesEscaped: '{n} predators left alive → 1 star only, −25% gold',
    penalty: 'Penalty: −{g} gold · −{x} EXP',
    wasted: '−1 move!', bonk: 'BONK!',
    ...
    foodShots: 'Eat for +{n} shots · {food} left', foodShotsShort: 'Eat +{n} · {food}',
    shotsAdded: '+{n} shots!', foodEmpty: 'No food left!',
    ...
    htShootD: 'Drag to aim and release — up to 3 stones may fly at once. Three touching colours break. Consecutive pops multiply score ×2 → ×3 → ×5 → ×8 → ×13 → ×21; a miss breaks the chain. Spend 1 food for 5 extra shots. Tap the spare stone to swap.',
    ...
    pairMode: 'Link Match', pairFlips: 'Tries', pairTries: 'Tries', pairLeft: '{n} pairs left',
    pairStreak: 'Clean link ×{n}!', pairBest: 'Best streak: {n}', pairCleared: 'Board cleared!',
    pairHint: 'HINT  ×{n}', pairNoHints: 'No hints left!',
    pairBlocked: 'Same image, but the path is blocked!', pairNotSame: 'Pick two matching images!',
    pairShuffled: 'No path — board shuffled!', pairOutOfTries: 'Out of tries',
    bravoFlips: 'Spare tries → gold',
    htPairT: 'Link Match — trace the glow',
    htPair1: 'Tap two MATCHING tiles. A valid pair vanishes and opens new paths.',
    htPair2: 'The link may cross empty spaces and go around the border, with at most TWO TURNS.',
    htPair3: 'Chain clean links for a score boost. Use HINT when stuck; a dead board reshuffles itself.',
    htSquare: 'Four gems in a 2×2 SQUARE also clear — not just rows and columns.',
    htRage: 'RAGE bar — fills from scoring AND from taking hits. Full means a blast: clears a row, hits every predator, score ×2.',
    fed: 'Energy', hungry: 'Exhausted', hungryBlock: 'Your cricket is spent — feed it first!',
    hungryHint: 'No energy, no journey — feed it or let it rest.',
    restWait: 'Out of energy. Rest {t}, or feed your cricket.',
    restIn: 'Ready to play in {t}', restFull: 'Full in {t}', orFeed: 'or feed it',
    restTitle: 'Your cricket is spent!', restBody: 'It cannot take another step — feed it, or let it rest a while.',
    costFed: '−{n} energy',
    chapterGo: 'Let’s go!', regionGo: 'On to the new land!',
    regionDone: 'CONQUERED', regionOpening: 'Opening the way onward…',
    regionNew: 'NEW LAND', regionSoon: 'Still being charted',
    regionSoonNote: 'This land opens in the next release.',
    rage: 'RAGE', furyGo: 'FURY!', furyOn: 'FURY · score ×2',
    furyOnShort: 'FURY  ·  SCORE ×2', furyBoost: 'FULL-SCREEN BLAST  ·  SCORE ×2', furyBadge: 'RAGE ×2',
    bag: 'Bag', sell: 'Sell', askBuy: 'Buy this?', askSell: 'Sell this?',
    askAfter: 'You will have {g} gold', askYesBuy: 'Buy', askYesSell: 'Sell', cancel: 'Cancel',
    shopSold: 'Sold {n} · +{g} gold', bagEmpty: 'Nothing in this slot yet.',
    shop: 'Shop', shopPoor: 'Not enough gold!', shopBought: 'Bought {n}!',
    shopEmpty: 'Nothing in this slot yet.', wear: 'Wear',
    needStage: 'Requires {s} to equip', reqStage: 'Needs {s}',
    ...
    outOfMoves: 'Out of moves', vitalityGone: 'Your cricket collapsed',
    newStage: 'Your cricket moulted!',

    praise: ['Good!', 'Nice!', 'Great!', 'Excellent!', 'Blazing!', 'THUNDER CHIRP!'],
  },
};

const KEY = 'cricko.lang';
const KEY_OLD = 'sdrakon.lang';                 // khoá cũ trước khi đổi tên game
let lang = 'vi';
try {
  const saved = localStorage.getItem(KEY) ?? localStorage.getItem(KEY_OLD);
