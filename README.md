...
|---|---|
| `SDrakon-1.0.0.apk` | **Android 7+** — chép vào máy, bật "cài từ nguồn không xác định" |
| `SDrakon Setup 1.0.0.exe` | **Windows** — bộ cài |
| `SDrakon 1.0.0.exe` | **Windows** — bản portable, chạy thẳng |
| `SDrakon-1.0.0-arm64.dmg` | **macOS** Apple Silicon |
| `SDrakon-1.0.0.dmg` | **macOS** Intel |
