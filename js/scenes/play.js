...
export default {
  ...
  drawOver(G, ctx) {
    ...
    for (let i = 0; i < 3; i++) {
      ...
      ctx.save();
      ctx.translate(W / 2 + (i - 1) * 82, 268);
      ctx.scale(pop, pop); ctx.rotate(on ? Math.sin(this.overT * 3 + i) * .06 : 0);
